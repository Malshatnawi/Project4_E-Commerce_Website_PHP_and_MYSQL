                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1"></div>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td style='width:10%'>{$row['product_name']}</td>";
                            echo "<td style='width:25%'>{$row['product_desc']}</td>";
                            echo "<td ><img src='{$row['product_image']}' style='width:10em; height:7em'></td>";
                            echo "<td style='width:7%'>{$row['product_price']}</td>";
                            echo "<td style='width:8%'>{$row['product_special']}</td>";
