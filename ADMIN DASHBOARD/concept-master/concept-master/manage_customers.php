    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="manage_customers.php">muchmore</a>
                    ...
                    <li class="nav-item">
                            <div id="custom-search" class="top-search-bar">
                                <form method="POST" class="d-flex">
                                    ...
                                    <button name="search" value="Search" class="btn btn-primary submit" ><i class="fas fa-search"></i></button>
                            </form>
                            </div>
                        </li>
                        <?php
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="#">Manage Customers</a>
                                ...
                                <div class="card-body">
                                    <table class="table-responsive">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)){
                                            ...
                                            echo "<tr>";
                                              echo "<td style='width:10%'>{$row['customer_id']}</td>";
                                              echo "<td style='width:10%'>{$row['customer_name']}</td>";
                                              echo "<td style='width:20%'>{$row['customer_email']}</td>";
                                              echo "<td style='width:20%'>{$row['customer_phone']}</td>";
                                              echo "<td style='width:20%'>{$row['customer_address']}</td>";
                                              echo "<td style='width:10%'><a href='edit_customers.php?id={$row['customer_id']}' class='btn btn-primary'>Edit</a></td>";
                                              echo "<td style='width:10%'><a href='delete.php?id={$row['customer_id']}' class='btn btn-danger'>Delete</a></td>";
                                              echo "</tr>";
                                        }
