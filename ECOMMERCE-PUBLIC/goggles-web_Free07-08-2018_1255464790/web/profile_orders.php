					...
					<ul class="navbar-nav nav-mega mx-auto">
						...
						<?php 
						 if(!isset($_SESSION['customer'])){
							...
							echo "<li class='nav-item'><a class='nav-link' href='http://localhost/E-Commerce%20Website%20PHP%20and%20MYSQL/CODE/ECOMMERCE-PUBLIC/goggles-web_Free07-08-2018_1255464790/web/profile_update.php'><i class='fa fa-user-circle-o' aria-hidden='true' style='margin-right:10px'></i>Update Profile</a></li>";
